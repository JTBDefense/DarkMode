...
public class DarkModeDropDownReceiver extends DropDownReceiver implements OnStateListener {
    ...
    private final SeekBar sliderMap;
    private final SeekBar sliderInterface;
    private final SeekBar sliderIcons;

    private final SeekBar sliderBrightness;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(SHOW_LAYOUT)) {
            showDropDown(_view, 0.4, FULL_HEIGHT, 0.5, HALF_HEIGHT, false, this);
        }
    }
